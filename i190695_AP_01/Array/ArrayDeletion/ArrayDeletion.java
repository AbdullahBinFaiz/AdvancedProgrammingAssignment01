...
public class ArrayDeletion{
	...
	//custom function added by me to be able to call the delete function
	public static int [] callDelete(int [] array, int indextodeleteAt){
		return delete(array, indextodeleteAt);
	}
