...
public class LinkedListWorking{
	int data;    
	LinkedListWorking nextPointer;
	
	static int numofElements;
	static LinkedListWorking headPointer;
	static LinkedListWorking tailPointer;

	public LinkedListWorking(){
		nextPointer=null;
	}
	...
	public void add(int number){
		...
		LinkedListWorking node = new LinkedListWorking();
		node.data=number;
	...
	public void display(){
		...
		System.out.print("[ ");
		LinkedListWorking temp = headPointer;
		while(temp!=null){
	...
	// custom function by me (i190695) to get array of linked list (for test cases)
	public int [] getArray() {
		int arraySize = 0;
		LinkedListWorking temp = headPointer;
		while (temp != null) {
		...
		int [] linkedListArray = new int[arraySize];
		temp = headPointer;
		int i = 0;
		while (temp != null) {
			linkedListArray[i] = temp.data;
			temp = temp.nextPointer;
			i++;
		}
